...
//        STEP2: Do assertion
        softAssert.assertTrue(title1.contains("iphone"),"iphone is not displayed");//soft assert
...
//       TC02: verify title contains 'porcelain teapot'
       // softAssert.assertTrue(title1.contains("porcelain teapot"),"porcelain teapot is not displayed");
...
//       TC03: verify title contains 'flower'
        softAssert.assertTrue(title1.contains("flower"),"flower is not displayed");
